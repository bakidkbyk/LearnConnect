...
//        // Uygulama genelindeki tema değişikliğine tepki ver
...
//        logoutButton.topToBottom(of: contentStackView).constant = 10
//    }
//}
//
...
//        
//        logoutButton.addTarget(self, action: #selector(logoutButtonTapepd), for: .touchUpInside)
//    }
//    @objc
//    func logoutButtonTapepd() {
